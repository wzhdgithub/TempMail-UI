package io.github.wzhdgithub.tempmailui.theme
...
import io.github.wzhdgithub.tempmailui.theme.dynamic.rememberDynamicColorSchemes

/** 主题配色/形态切换的统一动画时长（ms）。 */
const val THEME_ANIM_MS = 240
